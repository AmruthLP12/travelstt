export function generateHomePageSchema() {
  return {
    ...
    "@type": "Organization",
    name: "Tirumala Tirupathi Travels",
    url: "https://ttravels.com",
    logo: "https://ttravels.com/logo.png",
    ...
    sameAs: ["https://www.facebook.com/ttravels", "https://www.instagram.com/ttravels", "https://twitter.com/ttravels"],
  }
}
    ...
    itemListElement: [
      {
        ...
        item: {
          ...
          offers: {
            ...
            url: "https://ttravels.com/vehicles/swift-dzire",
          },
        },
      },
      {
        ...
        item: {
          ...
          offers: {
            ...
            priceValidUntil: "2025-12-31",
            availability: "https://schema.org/InStock",
            url: "https://ttravels.com/vehicles/toyota-innova",
          },
        },
      },
    ],
...
export function generateTemplePageSchema() {
  return {
    ...
    url: "https://ttravels.com/temples/tirumala-temple",
    address: {
      "@type": "PostalAddress",
