  ...
  return (
    <section className="mb-20 text-center max-w-4xl mx-auto" data-aos="fade-up">
      <div className="inline-block mb-6 relative">
        ...
        <h2 className="text-4xl font-bold text-white mt-2">Welcome to TT Travels</h2>
      ...
      <p className="text-xl text-gray-300 mt-8">
        Looking for reliable and affordable car or bus rentals in Tirupati? TT Travels offers a premium fleet including
