...
export default function TempleCard({ temple }: TempleCardProps) {
  return (
    <Card className="overflow-hidden border-0 border-gray-800 bg-gray-900 shadow-lg hover:shadow-xl transition-all duration-300 rounded-xl">
      ...
      <div className="p-6 bg-gray-900">
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-300">Timings: {temple.timings}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center">
              <Ticket className="h-4 w-4 text-indigo-400" />
            </div>
            <span className="text-sm text-gray-300">Entry: {temple.entryFee}</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center">
              <MapPin className="h-4 w-4 text-indigo-400" />
            </div>
            <span className="text-sm text-gray-300">Distance: {temple.distance}</span>
          </div>
        </div>
