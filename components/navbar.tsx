    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-800 bg-gray-900 shadow-md">
      <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl flex h-20 items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 text-transparent bg-clip-text hidden sm:inline-block">
            TT Travels
          </span>
        </div>
          ...
          >
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-lg font-bold bg-gradient-to-r from-indigo-400 to-purple-400 text-transparent bg-clip-text">
                  TT Travels
                </span>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 space-y-2">
                ...
                <p className="text-sm font-medium text-gray-300">+91 9391711883</p>
                <p className="text-sm font-medium text-gray-300">info@ttravels.com</p>
              </div>
            </div>
          </div>
        </div>
